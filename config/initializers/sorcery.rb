...
Rails.application.config.sorcery.configure do |config| 
  ...
  # config.twitter.callback_url = Rails.application.secrets.app_url + "/oauth/callback?provider=twitter"
  ...
  # config.facebook.callback_url = Rails.application.secrets.app_url + "/oauth/callback?provider=facebook"
